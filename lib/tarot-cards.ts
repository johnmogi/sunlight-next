...
export const TAROT_CARDS = [
  // MAJOR ARCANA
  {
    ...
    meaning: "The breathing child-sun at the center of everything. Four rays, four suits, one source.",
    visualDesc: "Four angels orbit a radiant feminine sun, representing the source of all elements.",
    type: "major" as const,
    number: 0
  },
  {
    ...
    meaning: "First spark of lucidity. One eye open on the crescent moon, diary in hand.",
    visualDesc: "Young woman half-awake in dream landscape, one eye closed in sleep one eye open with full awareness.",
    type: "major" as const,
    number: 1
  },
  {
    ...
    meaning: "Unconscious creation pouring from the sleeping mind.",
    visualDesc: "Sleeping figure whose hands gesture in unconscious creation, dreams flowing from their head like smoke.",
    type: "major" as const,
    number: 2
  },
  {
    ...
    meaning: "Half-awake imagination building floating cities in the desert.",
    visualDesc: "Young figure wandering through beautiful garden with glazed expression, lost in thought.",
    type: "major" as const,
    number: 3
  },
  {
  ...
  },
  {
    ...
    meaning: "Living spherical bonsai paradise with seven (and finally nine) sephiroth-fruit portals, circled by the black water-dragon kundalini.",
    visualDesc: "The Kabbalistic Tree of Life with glowing spheres connected by pathways, wrapped by a serpent.",
    type: "major" as const,
    number: 7
  },
  {
    ...
    meaning: "Soul chariot of light, fear vs surrender.",
    visualDesc: "Sacred Merkaba geometry with figure in meditation at center.",
    type: "major" as const,
    number: 8
  },
  {
    ...
    meaning: "The great Mother-Tiamat in the abyss-womb birthing the entire parallel dimension from the black ॐ pearl.",
    visualDesc: "The feminine creative force in cosmic waters, birthing reality from the primordial void.",
    type: "major" as const,
    number: 9
  },
  // MINOR ARCANA - ROSES (Air/Mind)
  {
    ...
    meaning: "The sword transformed into rose, mind unified with heart",
    suit: "roses" as const,
    type: "minor" as const,
    number: 1
  },
  ...
  // MINOR ARCANA - CARDS (Fire/Will)
  {
    ...
    meaning: "The wand as mirror-card, creative fire reflected back",
    suit: "cards" as const,
    type: "minor" as const,
    number: 1
  },
  ...
  // MINOR ARCANA - HEARTS (Water/Emotion)
  {
    ...
    meaning: "Pure emotional essence, the overflowing chalice",
  ...
  // MINOR ARCANA - COINS (Earth/Material)
  {
    ...
    meaning: "Material abundance blessed by spirit, earth infused with heaven",
    suit: "coins" as const,
    type: "minor" as const,
    number: 1
  },
